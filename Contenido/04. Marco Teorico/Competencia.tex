...
\phantomsection
\addcontentsline{toc}{subsubsection}{BBVA Bconomy}
\subsubsection*{BBVA Bconomy}
...
\phantomsection
\addcontentsline{toc}{subsubsection}{Fintonic}
\subsubsection*{Fintonic}
...
\begin{figure}[H]
	...
	\caption[{Logotipo de Fintonic.}]{\centering Logotipo de Fintonic. \textit{Fuente:} Qué es Fintonic y cómo nos puede ayudar en el control financiero, Ruiz R., 2019, Origen: https://eiposgrados.com/blog-direccion-financiera/que-es-fintonic-y-como-nos-puede-ayudar-en-el-control-financiero/} 
	\label{fig:fintonic}
\end{figure}

\phantomsection
\addcontentsline{toc}{subsubsection}{Nequi}
\subsubsection*{Nequi}
