...
\begin{enumerate}
	...
	\item Publicar avisos que informen a terceros sobre el inicio del proceso de liquidación de la sociedad.
	
	\item Elaborar un inventario del patrimonio social y el balance final de la empresa, detallando todos los activos y pasivos.
	
	\item Pagar el pasivo externo, es decir, las deudas con terceros, incluyendo obligaciones fiscales pendientes y la declaración de renta final.
	
	\item Distribuir los remanentes entre los socios o accionistas una vez canceladas todas las obligaciones.
	
	\item Elaborar el proyecto de liquidación, el cual deberá incluir:
