...
\begin{table}[H]
	...
	\includegraphics[width=13cm]{Imagenes/IndicadoresFinancierosPQ.png}
...
\begin{table}[H]
	...
	\includegraphics[width=9cm]{Imagenes/FlujoCajaLibrePQ.png}
...
\begin{table}[H]
	...
	\includegraphics[width=9cm]{Imagenes/VANTIRPQ.png}
	\label{VANTIR}
\end{table}
